...
def generate_map():
    ...
    for i in range(1, 81):
        ...
        z = i * 15
        y = 5 + (i % 5) * 3
        traps.append(create_obstacle([round(x, 2), round(y, 2), round(z, 2)], [4, 2, 4], f"RGB({i*3%255}, {i*7%255}, {i*11%255})"))
    return traps
...
if __name__ == "__main__":
    ...
    print("تم حفظ الخريطة في ملف map.json")
    print("الخدعة الأولى:", map_data[0])
    print("الخدعة الأخيرة:", map_data[-1])
